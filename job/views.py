...
from .serializers import JobSerializer, JobDetailSerializer, CetegorySerializer
...
class CategoriesView(APIView):
    def get(self, request, format=None):
        ...
        serializer = CetegorySerializer(categories, many=True)
...
class CreateJobView(APIView):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return Response({'status': 'Job created successfuly'})
    ...
    def delete(self, request, pk):
        ...
        return Response({'status': 'Job deleted successfuly'})
    ...
    def put(self, request, pk):
         ...
         return Response({'status': 'Job updated successfuly'})
